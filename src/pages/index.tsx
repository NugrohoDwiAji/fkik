...
export default function Home() {
  ...
  return (
    <div className="">
      {/* Banner */}
      <div className="bg-[url(/img/banner-fkdk.png)]  md:h-[31rem] lg:h-[40rem] bg-cover md:bg-right h-44">
        <div className="h-full w-full flex px-2 md:px-12 lg:px-20 items-center md:justify-between ">
          <div className="w-[50%] flex flex-col gap-2 -mt-9 md:-mt-20 lg:-mt-36">
            <h1 className=" font-semibold text-white md:text-shadow-lg/30 text-shadow-xs md:text-2xl lg:text-4xl uppercase text-sm mt-4 leading-4 md:leading-7 lg:leading-12">
            ...
            <a
              className=" md:mt-5 border-2 bg-white text-green-800 px-2 md:py-2 md:px-6 rounded-md  md:rounded-lg hover:scale-105 hover:shadow-2xl shadow-lg ease-in-out duration-300 transition-all text-xs md:text-xl w-fit hover:cursor-pointer flex items-center "
      ...
      <div className="flex flex-col items-center p-5 gap-5 lg:h-[40rem]">
        <h1 className="text-xl lg:text-2xl font-bold lg:mt-10  text-green-800">
          Tentang Fakultas
        </h1>
        <div className="bg-green-800 w-[50%] md:w-[25%] lg:w-[14%] h-[2px] lg:mb-5 " ></div>
        <div className="md:flex gap-32 justify-center lg:px-14 md:h-[28rem] pb-10 ">
          ...
          <div className="md:w-[45%] h-full flex flex-col gap-5 justify-center">
            ...
            <ButtonPrimary
              ClassName="bg-green-800 text-white hover:text-green-800 hover:bg-white hover:border-2 hover:border-green-800 font-semibold ease-in-out duration-300 transition-all"
      ...
      <div className="h-fit bg-[url(/img/bg-kampus.jpg)] bg-center bg-cover">
        <div className="bg-gradient-to-r from-green-600 to-green-800  h-full text-white font-bold flex justify-center items-center gap-6 md:gap-20 lg:gap-36 py-3 md:py-12 px-4 flex-wrap md:flex-row  ">
      ...
      <div className="flex flex-col items-center py-5 lg:py-10 bg-white gap-5 h-fit">
        <h1 className="text-xl lg:text-2xl font-bold text-green-800">
          Berita
        </h1>
        <hr className="border-t-[3px] border-green-800 w-[20%] md:w-[15%] lg:w-[6%]  mb-5" />
      ...
      {/* Pengumuman */}
      <div className="h-fit bg-[url(/img/bg-kampus.jpg)] bg-center bg-cover">
        <div className="bg-gradient-to-r from-green-600 to-green-800  h-full flex justify-center items-center gap-6 md:gap-20 lg:gap-36 py-3 md:py-12 px-4 flex-wrap md:flex-row  ">
          <div className="flex flex-col items-center">
            ...
            <div className="w-screen mt-16">
              <Carausel>
               ...
               <div className="mt-10 w-full flex justify-center">
            <ButtonPrimary
              ClassName="hover:bg-green-800 m-auto hover:text-white text-green-800 bg-white border-2 border-green-800 font-semibold ease-in-out duration-300 transition-all"
      ...
      <div className="flex flex-col items-center py-5 lg:py-10 bg-white  h-fit">
        <h1 className="text-xl lg:text-2xl font-bold text-green-800">FAQ</h1>
