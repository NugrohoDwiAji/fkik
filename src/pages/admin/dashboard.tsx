  ...
  return (
    <AdminLayout>
      ...
      <form className="">
          ...
          <div className="w-[40%] flex flex-col gap-5 ">
            <div className="flex gap-2 items-center  ">
              ...
              <input
                ...
                type="text"
                className="bg-white p-2 rounded-lg focus:outline-green-400 outline-2 outline-green-100 w-60"
              />
            </div>
            <div className="flex gap-2 items-center ">
              <label htmlFor="" className="w-44 ">
              ...
              <input
                ...
                type="number"
                className="bg-white p-2 rounded-lg focus:outline-green-400 outline-2 outline-green-100 w-14"
              />
            </div>
            <div className="flex gap-2 items-center ">
              <label htmlFor=" " className="w-44 ">
          ...
          <div className="w-[40%] flex flex-col gap-5 ">
            <div className="flex gap-2 items-center ">
              ...
              <input
                ...
                className="bg-white p-2 rounded-lg focus:outline-green-400 outline-2 outline-green-100"
              />
            </div>
        ...
        {canEdit && (
          <ButtonPrimary
            ClassName="bg-green-400 text-white hover:bg-white hover:text-green-400 hover:border-2 hover:border-green-400 ease-in-out duration-300 transition-all mt-10 mb-5"
        ...
        {canEdit && (
          ...
          <ButtonPrimary
            ClassName="bg-green-400 text-white hover:bg-white hover:text-green-400 hover:border-2 hover:border-green-400 ease-in-out duration-300 transition-all mb-5 mt-5"
        ...
        {canEdit && (
          <div className="flex flex-col ">
            <ButtonPrimary
              ClassName="bg-green-400 text-white hover:bg-white hover:text-green-400 hover:border-2 hover:border-green-400 ease-in-out duration-300 transition-all mt-5"
      ...
      <div className="bg-white rounded-xl mt-10 ">
        <h1 className="bg-green-300 p-5 rounded-t-xl text-green-700 font-bold">
          Grafik Kunjungan
        </h1>
