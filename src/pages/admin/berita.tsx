...
export default function Berita() {
  ...
  return (
    <AdminLayout>
      <h1 className="text-4xl text-green-400 ">Berita</h1>
      <div className="flex gap-5">
        <ButtonPrimary
          ClassName="text-white bg-green-400 hover:bg-white hover:text-green-400 hover:border-2 hover:border-green-400 ease-in-out duration-300 transition-all mt-5"
          ...
          <div className="flex items-center justify-center gap-20 w-full mt-5">
            <div className="flex items-center gap-5 ">
              ...
              <input
                ...
                className="bg-white p-2 focus:outline-green-400 rounded-lg outline-blue-100 outline-2"
              />
            </div>
            <div className="flex items-center gap-5 ">
              ...
              <textarea
                ...
                className="bg-white h-40 p-2 focus:outline-green-400 rounded-lg outline-blue-100 outline-2 w-96 "
              ></textarea>
            </div>
            <div className="flex items-center gap-5 ">
              <label htmlFor="" >Tanggal</label>
              <input type="date" onChange={(e) => setPushData({ ...pushData, tanggal:new Date(e.target.value)})} className="bg-white p-2 focus:outline-green-400 rounded-lg outline-blue-100 outline-2" />
            </div>
          </div>
        </div>
      )}
      ...
      <table className="table-fixed border-collapse mt-10  m-auto rounded-2xl">
        <thead className="text-white">
          <tr className="">
            ...
            <th className=" lg:w-60 bg-green-400 border-x border-gray-300 ">
              Judul Berita
            </th>
            <th className=" lg:w-2xl bg-green-400 border-x border-gray-300 ">
              Deskripsi
            </th>
            <th className=" lg:w-2xl bg-green-400 border-x border-gray-300 ">
              Gambar
