...
export default function ContactHeader({ isScroll }: Props) {
 const [identitas, setIdentitas] = useState<IdentitasType[] | null>([])
  ...
  return (
    <div
      className={`h-10 lg:h-16 w-full text-white flex justify-between px-6 md:px-8 lg:px-24 ${
        isScroll ? "hidden" : "bg-gradient-to-r from-green-800 to-green-400 shadow-2xl shadow-yellow-400 " 
